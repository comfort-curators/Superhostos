  ...
  const messages = [
    {
      ...
      aiResponse:
        "I apologize for the WiFi issue. I've reset your connection and the password is: Hotel2024Guest. You should be connected within 2 minutes.",
    ...
    },
    {
      ...
      aiResponse:
        "Of course! I've arranged for housekeeping to bring extra towels within 15 minutes. I've also approved late checkout until 2 PM at no charge.",
    ...
    <div className="min-h-screen p-8" style={{ backgroundColor: 'var(--cream)' }}>
      ...
      >
        <div className="flex justify-between items-center mb-4">
          <h1 className="text-5xl bodoni" style={{ color: 'var(--charcoal)', fontWeight: 400 }}>
      ...
      >
        <h2 className="text-3xl mb-6 bodoni" style={{ color: 'var(--charcoal)' }}>
...
function LiveDemo() {
  ...
  const handleSubmit = async () => {
    ...
    const responses: Record<string, { response: string; task: string }> = {
      wifi: {
        response:
          "I apologize for the WiFi issue. I've reset your connection and the password is: Hotel2024Guest. Our tech team has been notified.",
        task: 'Tech Support — WiFi Reset — Room 205',
      },
      towel: {
        response:
          "Of course! I've requested housekeeping to bring extra towels to your room within 15 minutes.",
        task: 'Housekeeping — Extra Towels — Room 205',
      },
      checkout: {
        response:
          'Checkout is at 11 AM, but I can arrange a late checkout until 2 PM at no charge. Your bill will be ready at the front desk.',
    ...
    const result = keyword
      ...
      : {
          response:
            "Thank you for your message. I've forwarded this to our staff and someone will assist you shortly.",
