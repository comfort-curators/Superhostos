...
// --- Inventory items ------------------------------------------------------
export const inventoryCategorySchema = z.enum(['amenities', 'linen', 'consumables', 'cleaning', 'minibar']);
...
// --- Decision output ------------------------------------------------------
export const decisionModeSchema = z.enum(['optimized', 'consensus_buffered', 'fallback', 'skipped']);
